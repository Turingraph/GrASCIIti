...
int	main(void)
{
	...
	int			output;
	t_line		line[] = {
		{3, 7, 8, 10, .row=20, .col=20},
		{8, 3, 10, 17, .row=20, .col=20},
		{10, 4, 8, 16, .row=20, .col=20},
		{11, 4, 1, 9, .row=20, .col=20},
		{7, 17, 0, 14, .row=20, .col=20},
		{6, 18, 3, 0, .row=20, .col=20},
		{3, 19, 5, 2, .row=20, .col=20},
		{2, 13, 16, 10, .row=20, .col=20}
	};
