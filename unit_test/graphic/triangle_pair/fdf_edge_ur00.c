...
int	main(void)
{
	...
	t_triangle_tester	testers[] = {
		{
			.row = 0, .col = 0, .length = 0, .file_name = "10-70.fdf", .points = (t_3d_point []){
				{.x = 0.0, .y = 0.0, .z = 61.0}, {.x = 1.0, .y = 1.0, .z = 4.0}
			}
		},
		{
			.row = 3, .col = 18, .length = 0, .file_name = "20-60.fdf", .points = (t_3d_point []){
		...
		{
			.row = 27, .col = 3, .length = 2, .file_name = "50-4.fdf", .points = (t_3d_point []){
				{.x = 3.0, .y = 28.0, .z = 4.0}, {.x = 4.0, .y = 27.0, .z = 5.0}
			}
		},
		{
			//
			.row = 91, .col = 7, .length = 2, .file_name = "100-6.fdf", .points = (t_3d_point []){
		...
		{
			.row = 6, .col = 1, .length = 2, .file_name = "elem-col.fdf", .points = (t_3d_point []){
				{.x = 1.0, .y = 7.0, .z = 3.0}, {.x = 2.0, .y = 6.0, .z = 7.0}
			}
		},
		{
			.row = 6, .col = 2, .length = 0, .file_name = "elem-col.fdf", .points = (t_3d_point []){
		...
		{
			// ***
			.row = 12, .col = 13, .length = 0, .file_name = "elem2.fdf", .points = (t_3d_point []){
				{.x = 12.0, .y = 14.0, .z = 50.0}, {.x = 13.0, .y = 13.0, .z = 50.0}
			}
		},
		{
			// ***
			.row = 12, .col = 12, .length = 2, .file_name = "elem2.fdf", .points = (t_3d_point []){
