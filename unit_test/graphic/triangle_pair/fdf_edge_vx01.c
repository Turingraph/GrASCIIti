...
int	main(void)
{
	...
	t_triangle_tester	testers[] = {
		{
			.row = 1, .col = 1, .length = 2, .file_name = "10-70.fdf", .points = (t_3d_point []){
		...
		{
			.row = 27, .col = 4, .length = 2, .file_name = "50-4.fdf", .points = (t_3d_point []){
				{.x = 4.0, .y = 27.0, .z = 5.0}, {.x = 5.0, .y = 27.0, .z = 2.0}
			}
		},
		{
			.row = 74, .col = 7, .length = 2, .file_name = "100-6.fdf", .points = (t_3d_point []){
