...
int	main(void)
{
	...
	t_triangle_tester	testers[] = {
		...
		{
			.row = 3, .col = 0, .length = 2, .file_name = "20-60.fdf", .points = (t_3d_point []){
				{.x = 0.0, .y = 3.0, .z = 42.0}, {.x = 0.0, .y = 4.0, .z = 93.0}
			}
		},
		{
			.row = 6, .col = 11, .length = 2, .file_name = "42.fdf", .points = (t_3d_point []){
				{.x = 11.0, .y = 6.0, .z = 10}, {.x = 11.0, .y = 7.0, .z = 10}
			}
		},
		{
			// ***
			.row = 48, .col = 44, .length = 2, .file_name = "50-4.fdf", .points = (t_3d_point []){
				{.x = 44.0, .y = 48.0, .z = 6.0}, {.x = 44.0, .y = 49.0, .z = 3.0}
			}
		},
		{
			.row = 74, .col = 2, .length = 0, .file_name = "100-6.fdf", .points = (t_3d_point []){
				{.x = 7.0, .y = 74.0, .z = 2.0}, {.x = 8.0, .y = 74.0, .z = 2.0}
			}
		},
		{
			.row = 18, .col = 4, .length = 0, .file_name = "basictest.fdf", .points = (t_3d_point []){
		...
		{
			.row = 7, .col = 8, .length = 2, .file_name = "elem.fdf", .points = (t_3d_point []){
		...
		{
			.row = 7, .col = 19, .length = 0, .file_name = "pentenegpos.fdf", .points = (t_3d_point []){
	...
	while (i < max_score)
	{
		table = open_table_fdf_file(testers[i].file_name, "input_examples/fdf_positive/", parse_fdf_line_bw, false);
...
/*
valgrind --leak-check=full --show-leak-kinds=all ./unit_test/out/graphic/triangle_pair/fdf_edge_vy00.out
*/