...
int	main(void)
{
	...
	size_t				index;
	e_edge				edge_mode = EDGE_Y;
	t_triangle_tester	testers[] = {
		{
			.row = 1, .col = 1, .length = 0, .file_name = "10-70.txt", .points = (t_3d_point []){
				{.x = 1.0, .y = 1.0, .z = 4.0}, {.x = 2.0, .y = 1.0, .z = 90.0}
			}
		},
		{
			.row = 3, .col = 0, .length = 2, .file_name = "20-60.txt", .points = (t_3d_point []){
				{.x = 0.0, .y = 3.0, .z = 42.0}, {.x = 0.0, .y = 4.0, .z = 79.0}
			}
		},
		{
			.row = 6, .col = 11, .length = 2, .file_name = "42.txt", .points = (t_3d_point []){
				{.x = 11.0, .y = 6.0, .z = 10}, {.x = 11.0, .y = 7.0, .z = 10}
			}
		},
		{
			// ***
			.row = 48, .col = 44, .length = 2, .file_name = "50-4.txt", .points = (t_3d_point []){
				{.x = 44.0, .y = 48.0, .z = 6.0}, {.x = 44.0, .y = 49.0, .z = 3.0}
			}
		},
		{
			.row = 74, .col = 2, .length = 0, .file_name = "100-6.txt", .points = (t_3d_point []){
				{.x = 7.0, .y = 74.0, .z = 2.0}, {.x = 8.0, .y = 74.0, .z = 2.0}
			}
		},
		{
			.row = 18, .col = 4, .length = 0, .file_name = "basictest.txt", .points = (t_3d_point []){
		...
		{
			.row = 4, .col = 4, .length = 0, .file_name = "elem-col.txt", .points = (t_3d_point []){
				{.x = 0, .y = 0, .z = 0}, {.x = 0, .y = 0, .z = 0}
			}
		},
		{
			.row = 7, .col = 9, .length = 0, .file_name = "elem-col.txt", .points = (t_3d_point []){
				{.x = 7.0, .y = 7.0, .z = 2.0}, {.x = 8.0, .y = 7.0, .z = 5.0}
			}
		},
		{
			.row = 7, .col = 8, .length = 2, .file_name = "elem.txt", .points = (t_3d_point []){
				{.x = 8.0, .y = 7.0, .z = 5.0}, {.x = 8.0, .y = 8.0, .z = 3.0}
			}
		},
		{
			// ***
			.row = 8, .col = 4, .length = 2, .file_name = "elem2.txt", .points = (t_3d_point []){
				{.x = 4.0, .y = 8.0, .z = 50.0}, {.x = 4.0, .y = 9.0, .z = 50.0}
			}
		},
		{
			.row = 7, .col = 19, .length = 0, .file_name = "pentenegpos.txt", .points = (t_3d_point []){
				{.x = 19.0, .y = 8.0, .z = 9.0}, {.x = 20.0, .y = 8.0, .z = 10.0}
			}
		},
	};
...
/*
valgrind --leak-check=full --show-leak-kinds=all ./unit_test/out/graphic/triangle_pair/fdf_edge_vy01.out
*/