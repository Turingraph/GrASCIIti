...
int	main(void)
{
	...
	t_triangle_tester	testers[] = {
		...
		{
			// ***
			.row = 48, .col = 44, .length = 0, .file_name = "50-4.fdf", .points = (t_3d_point []){
		...
		{
			// ***
			.row = 8, .col = 4, .length = 0, .file_name = "elem2.fdf", .points = (t_3d_point []){
...
/*
valgrind --leak-check=full --show-leak-kinds=all ./unit_test/out/graphic/triangle_pair/fdf_edge_uy00.out
*/