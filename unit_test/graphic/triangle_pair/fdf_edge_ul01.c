...
int	main(void)
{
	...
	t_triangle_tester	testers[] = {
		{
			.row = 0, .col = 0, .length = 2, .file_name = "10-70.txt", .points = (t_3d_point []){
				{.x = 0.0, .y = 0.0, .z = 61.0}, {.x = 1.0, .y = 1.0, .z = 4.0}
			}
		},
		{
			.row = 3, .col = 18, .length = 2, .file_name = "20-60.txt", .points = (t_3d_point []){
				{.x = 18.0, .y = 3.0, .z = 30.0}, {.x = 19.0, .y = 4.0, .z = 79.0}
			}
		},
		{
		...
		{
			.row = 21, .col = 14, .length = 0, .file_name = "50-4.txt", .points = (t_3d_point []){
				{.x = 44.0, .y = 48.0, .z = 6.0}, {.x = 44.0, .y = 49.0, .z = 3.0}
			}
		},
		{
			.row = 98, .col = 2, .length = 2, .file_name = "100-6.txt", .points = (t_3d_point []){
		...
		{
			.row = 7, .col = 7, .length = 2, .file_name = "elem-col.txt", .points = (t_3d_point []){
		...
		{
			// ***
			.row = 11, .col = 4, .length = 2, .file_name = "elem2.txt", .points = (t_3d_point []){
...
/*
valgrind --leak-check=full --show-leak-kinds=all ./unit_test/out/graphic/triangle_pair/fdf_edge_ul01.out
*/