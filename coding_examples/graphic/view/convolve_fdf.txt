...
int	main(int len, char **str)
{
	...
	t_rgba		target_channels = {.r = 1, .g = 0, .b = 1, .a = 0};
	t_matrix	kernel;
	...
	kernel = gaussian_kernel(3, 0.4, 0.5);
...
/*
valgrind --leak-check=full --show-leak-kinds=all ./coding_examples/out/graphic/view/convolve_fdf.out input_examples/fdf/42.fdf
