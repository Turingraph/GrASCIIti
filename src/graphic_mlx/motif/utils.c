...
/*   Updated: 2026/08/31 16:07:56 by phsottat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// // time : O(1)
// // space: O(1)
// t_2d_int	world_to_screen_2d(t_complex world)
// {
// 	t_2d_int	dst;

// 	dst.x = world_to_screen_xy(0, world.re);
// 	dst.y = world_to_screen_xy(0, world.im);
// 	return (dst);
// }
