...
// time : O(1)
// space: O(1)
t_triangle	f_fdf_triangle(const t_table_fdf *src, size_t row, size_t col, char mode)
{
	t_triangle	dst;
...
// time : O(1)
// space: O(1)
int	count_2_fdf_triangles(const t_table_fdf *src, size_t row, size_t col, char *mode)
{
	int		y;
...
// time : O(1)
// space: O(1)
float	test_2_fdf_triangles(const t_table_fdf *src, size_t row, size_t col)
{
	float		y;
	float		*target;
	t_triangle	triangle;
