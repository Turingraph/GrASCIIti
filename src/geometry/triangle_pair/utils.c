...
// time : O(1)
// space: O(1)
char	fdf_side_detection(const t_table_fdf *src, size_t row, size_t col, char axis)
{
...
// time : O(1)
// space: O(1)
unsigned char	triangle_face_rgb(const t_table_fdf *src, size_t row, size_t col, e_rgba rgb_type)
{
	float	drgb;
