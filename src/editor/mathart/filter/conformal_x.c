...
{
	return (is_conformal_x_func(row, col, dst, complex_square));
}
...
{
	return (is_conformal_x_func(row, col, dst, complex_cube));
}
...
{
	return (is_conformal_x_func(row, col, dst, complex_sin));
}
...
{
	return (is_conformal_x_func(row, col, dst, complex_reciprocal));
}
