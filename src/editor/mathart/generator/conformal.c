...
{
	return (gen_conformal_func(row, col, dst, complex_cube));
}
...
{
	return (gen_conformal_func(row, col, dst, complex_sin));
}
...
{
	return (gen_conformal_func(row, col, dst, complex_reciprocal));
}
