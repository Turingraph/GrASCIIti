...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/08/24 21:09:07 by phsottat          #+#    #+#             */
/*   Updated: 2026/08/24 22:14:06 by phsottat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef enum t_e7cell_channels
{
	D7_RED,
	D7_GREEN,
	D7_BLUE,
...
void			color_cells_gradient(t_table_fdf *dst,
					...
					bool is_overwrite,
					bool (*is_filtered_cell)(const t_table_fdf *dst,
						size_t index));
